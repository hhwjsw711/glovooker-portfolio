...
interface Props {
    ...
    handleUserSubmit: (data: { firstName: string; lastName: string }) => void;
    ...
    return (
        ...
        >
                ...
                <div className="w-1/2 flex flex-col relative z-20 mt-12">
                    ...
                    <div className="flex mt-10 sm:mt-20 relative z-20">
                        <div className="hidden md:flex">
                            ...
                            />
                            <Button
                                label={t('create_badge').toString()}
                                onClick={props.sectionsRef.createBadgeRef.scrollTo}
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className="block w-full md:w-1/2 lg:1/2 xl:w-full h-full relative z-20">
                <InteractiveBadge user={props.userData} />
            </div>
        </section>
    );
};
